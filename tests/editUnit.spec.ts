...
//TODO:
//placeholders: separate, photo: add check that is not changed

//model , features, description, 


//     test("Check 'Місце розташування технічного засобу' functionality", async ({
//         ownerUnitsPage,
//         editUnitPage,
//         unitPage,
//     }) => {
...
//     test("Image section functionality", async ({
//         ownerUnitsPage,
//         editUnitPage,
//         unitPage,
//     }) => {
...
//     test("Check services functionality", async ({
//         ownerUnitsPage,
//         editUnitPage,
//         unitPage,
//         apiHelper,
...
//     test("Check 'Спосіб оплати' menu", async ({
//         ownerUnitsPage,
//         editUnitPage,
//         unitPage,
//     }) => {
...
//     test("Check 'Вартість мінімального замовлення' field", async ({
//         ownerUnitsPage,
//         editUnitPage,
//         unitPage,
//     }) => {
...
//     test.afterEach(async ({ createUnitApiHelper }) => {
//         // Delete created unit using API
//         let responseStatus = await createUnitApiHelper.deleteUnit();
